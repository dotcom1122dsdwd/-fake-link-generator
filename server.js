...
function createFakeLink(realTargetUrl) {
  ...
  return ${NGROK_URL}//?id=&export=download&name=;
}
...
app.listen(PORT, '0.0.0.0', () => {
  console.log(\🚀 เซิร์ฟเวอร์ทำงานที่ http://0.0.0.0:\\);
  console.log(\🌐 ใช้ ngrok URL: \\);
  console.log(\🔗 เส้นทางที่ใช้: /\/:token\);

  const sampleLink = createFakeLink('https://www.google.com');
  console.log(\🔗 ลิงก์ปลอมตัวอย่าง (อายุ 24 ชม.): \\);
